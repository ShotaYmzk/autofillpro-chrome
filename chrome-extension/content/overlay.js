...
const AutoFillOverlay = (() => {
  ...
  const FIELD_LABELS = {
    ...
    homePrefecture: '休暇先都道府県', homeCity: '休暇先市区町村',
    homeAddress: '休暇先番地',        homeBuilding: '休暇先建物',
    zipVacation1: '休暇先郵便①', zipVacation2: '休暇先郵便②',
    prefectureVacation: '休暇先都道府県', cityVacation: '休暇先市区町村',
    addressVacation: '休暇先番地', buildingVacation: '休暇先建物',
    vacationAddressLine: '休暇先住所（1行）',
    telVacation1: '休暇先電話①', telVacation2: '休暇先電話②', telVacation3: '休暇先電話③',
    schoolType: '学校区分',
    schoolSetup: '設置区分',
    degree: '学位',
    ...
    schoolListPick: '学校（一覧から選択）',
    facultySelectPick: '学部・研究科（一覧）',
    deptSelectPick: '学科・専攻（一覧）',
    declaredStream: '申告文理',
    gradSchoolName: '大学院名', gradSchoolKana: '大学院名ふりがな',
    univName: '大学名',    univKana: '大学名ふりがな',
    univPref: '大学所在地',
    gradSchoolPref: '大学院所在地',
    priorSchoolCategory: '出身大学の区分',
    faculty: '学部',       dept: '学科',
    enrollYear: '入学年',  enrollMonth: '入学月',
    graduationStatus: '卒業区分',
    ...
    vacationSameAsCurrent: '休暇先＝現住所と同じ',
    jushosame: '現在の連絡先と同じ',
  };
